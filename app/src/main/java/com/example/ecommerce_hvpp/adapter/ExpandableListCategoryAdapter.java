...
public class ExpandableListCategoryAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListCategoryAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.list_category_title, null);
        }
